...
namespace cs_sequence {
	...
	* *****************************************************************************/
	private:
		...
		/// <summary>
		/// update cursors till data is matched
		/// </summary>
		/// <param name="target"></param>
		void findData(const  ItemType& target);
	...
	public:
		...
		SequenceTemplate(const SequenceTemplate& copyMe);
		...
		SequenceTemplate& operator=( const SequenceTemplate& copyMe);
	};
